...
beforeEach(async () => {
  ...
  config.nullPlusUndefined = false
  config.outputAsTypes = false
})
...
describe('inferTable', () => {
  ...
  it('works with nullPlusUndefined = true', async () => {
    config.nullPlusUndefined = true
    const code = await inferTable(connectionString, 'complex')
    expect(code).toMatchInlineSnapshot(`
      "/**
       * AUTO-GENERATED FILE @ ${time} - DO NOT EDIT!
  ...
  it('works with types = true', async () => {
    config.outputAsTypes = true
    const code = await inferTable(connectionString, 'complex')
    expect(code).toMatchInlineSnapshot(`
      "/**
       * AUTO-GENERATED FILE @ ${time} - DO NOT EDIT!
       ...
       * should be able to ommit these fields if you'd like
       */
      export type ComplexWithDefaults = {
        id: string
        name: string
        nullable?: string | null
        /**  Defaults to: CURRENT_TIMESTAMP */
